...
func (application *application) SendEmail(from, to, subject, tmplName string, attachments []string, tmplData interface{}) error {
	templateToRender := fmt.Sprintf("email-templates/%s.gohtml", tmplName)
	...
	templateToRender = fmt.Sprintf("email-templates/%s.plain.gohtml", tmplName)
